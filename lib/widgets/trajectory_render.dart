...
class TrajectoryPainter extends CustomPainter {
  ...
  if (trajectory != null) {
    ...
    if (sampleTime == null) {
    PathPainterUtil.paintRobotOutline(
      physicsResult!.states.first.pose,
      fieldImage,
      robotConfig.bumperSize,
      robotConfig.bumperOffset,
      scale,
      ...
      robotFeatures);
    PathPainterUtil.paintRobotOutline(
      physicsResult!.states.last.pose,
      fieldImage,
      robotConfig.bumperSize,
      robotConfig.bumperOffset,
      scale,
    ...
    final PhysicsSimState state = physicsResult!.sample(sampleTime!);
    PathPainterUtil.paintRobotOutline(
      state.pose,
      fieldImage,
      robotConfig.bumperSize,
